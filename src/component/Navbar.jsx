...
import { Box, Stack, Button, FormControlLabel, Switch } from "@mui/material";
  ...
  return (
    ...
    >
      <ol style={{ listStyleType: "none" }}>
        <li>
          <img src="images/Al3rapyImages/Untitled.png" alt="" />
        </li>
        <Stack
          direction="row"
          spacing={4}
        >
          ...
          <li>
            <Link
              ...
              exact
              className={checkClickLink == "championships" ? "link1" : "link"}
            >
              {" "}
              بطولات العربي{" "}
            </Link>
        ...
        <Stack direction="row" spacing={4}>
          <li>
            <Link
              target="_blank"
              to="https://api.whatsapp.com/send/?phone=201287194379&text&type=phone_number&app_absent=0"
            >
              <Button color="warning" variant="outlined" className="btn-hover">
                <WhatsAppIcon style={{ color: "#5fffa2", marginLeft: "3px" }} />{" "}
                Contact Us
              </Button>
            </Link>
          </li>
