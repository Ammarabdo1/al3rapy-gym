...
const Al3rapyFamilyUSA = (props) => {
  ...
  return (
    <div className="heros">
      ...
      >
        <div className="text-heros" data-aos="zoom-in" style={{marginLeft:'40px'}}>
          <Typography variant="h6" style={{ color: "gold" }}>
            Al-Arabi family
            <Diversity1Icon style={{ fontSize: "1.8rem", marginLeft: "5px" }} />
          </Typography>
          <Typography variant="h2" style={{ color: "white", display: "flex" }}>
          my brothers and I am proud of them
            <Diversity2Icon style={{ fontSize: "5rem", marginLeft: "15px" }} />
          </Typography>
          <Typography variant="h6" style={{ color: " white" }}>
          My relationship with the players is a friendship, not just a coaching relationship
          </Typography>
        </div>
      ...
      <Stack
        className="Photos"
        style={{ background: props.checkDarkMode ? "#152024" : "" }}
      >
        <Grid container className="allImages">
          {ImgCounter.map((img, i) => (
            <Grid lg={3} sm={4} xs={12}>
              <div className="div-hero-img">
                <img src={`images/Al3rapyFamily/F${i + 1}.jpg`} alt="family" />
              </div>
            </Grid>
          ))}
        </Grid>
...
export default Al3rapyFamilyUSA;
